...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class VolumeWeightedAveragePriceExecutionModelRegressionAlgorithm : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public Dictionary<string, string> ExpectedStatistics => new Dictionary<string, string>
        {
            ...
            {"Average Win", "0.05%"},
            {"Average Loss", "-0.01%"},
            {"Compounding Annual Return", "434.442%"},
            {"Drawdown", "1.300%"},
            {"Expectancy", "1.891"},
            {"Net Profit", "2.166%"},
            {"Sharpe Ratio", "11.671"},
            {"Probabilistic Sharpe Ratio", "70.321%"},
            {"Loss Rate", "30%"},
            {"Win Rate", "70%"},
            ...
            {"Return Over Maximum Drawdown", "482.73"},
            ...
            {"OrderListHash", "c43fecd07d958d52f42ccc6c0137d921"}
        };
    }
}
